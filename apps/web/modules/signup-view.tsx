          ...
          <div className="ml-auto mr-auto mt-0 flex w-full max-w-xl flex-col px-4 pt-6 sm:px-16 md:px-20 lg:mt-24 2xl:px-28">
            ...
            {!displayEmailForm && (
              <div className="mt-12">
                ...
                <div className="mt-6 flex flex-col gap-2 md:flex-row">
                  ...
                  {isGitHubLoginEnabled ? (
                    <Button
                      ...
                      onClick={async () => {
                        await signIn("github", { callbackUrl: `${WEBAPP_URL}/getting-started?from=signup` });
                      }}>
                  ...
                  {isFacebookLoginEnabled ? (
                    <Button
                      ...
                      className={classNames("w-full justify-center rounded-md text-center")}
                      data-testid="continue-with-facebook-button"
                      onClick={async () => {
                        await signIn("facebook", { callbackUrl: `${WEBAPP_URL}/getting-started?from=signup` });
                      }}>
                ...
                {(isGoogleLoginEnabled || isGitHubLoginEnabled || isFacebookLoginEnabled) && (
                  <div className="mt-6">
